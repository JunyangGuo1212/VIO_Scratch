function [outputArg1,outputArg2] = run_kf_INS_gui(app)
load('data/sinmotiondata2d.mat');
...
scatter(app.UIAxes2, X_list(4,:), X_list(5,:));
hold(app.UIAxes2,'on'); scatter(app.UIAxes2, data2d.GPS.pos_EN(1,:),data2d.GPS.pos_EN(2,:));
legend(app.UIAxes2, 'Estimation', 'Ground Truth');

% figure; 速度
x = 1:length(X_list(2,:));
plot(app.UIAxes3, x,X_list(2,:));
hold(app.UIAxes3, 'on'); plot(app.UIAxes3, x,X_list(3,:));
legend(app.UIAxes3, 'Velocity x', 'Velocity y');
